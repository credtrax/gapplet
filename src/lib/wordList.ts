 ...
 * import gymnastics.
 *
 * 13,607 words: the public-domain ENABLE list
 * (https://github.com/dolph/dictionary, enable1.txt) filtered to 1-5
 * letter words. Regenerate with the recipe in docs/DICTIONARY.md.
 */
